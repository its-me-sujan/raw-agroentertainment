...
function updateButtonStyles(selectedBtn, otherBtn1, otherBtn2) {
  selectedBtn.className = "my-4 h-fit w-fit py-3 px-10 bg-[#961E00] rounded-full";
  selectedBtn.querySelector("span").className = "text-2xl text-white";

  otherBtn1.className = "my-4 h-fit w-fit py-3 px-10 border border-[#961E00] rounded-full";
  otherBtn1.querySelector("span").className = "text-2xl text-[#961E00]";

  otherBtn2.className = "my-4 h-fit w-fit py-3 px-10 border border-[#961E00] rounded-full";
